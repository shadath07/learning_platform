...
urlpatterns=[
    ...
    path('coursestudents-api/<int:course_id>/',views.course_students_api, name='coursestudents-api'),
    ...
    path('editcontent-api/<int:course_id>/<int:content_id>/',views.edit_content_api,name='editcontent-api'),
